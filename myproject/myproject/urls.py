...
urlpatterns = [
    ...
    path("verify-payment/<int:order_id>/", verify_payment, name="verify_payment"),
    ...
    path("forgot-password/success/", forgot_password_success, name="forgot_password_success"),
    # seller
    ...
    path(
        ...
        seller_cancel_order,
        name="seller_cancel_order",
    ),
    path(
        "seller/orders/<int:order_id>/process_refund/",
        seller_process_refund,
        name="seller_process_refund",
    ),
    path(
        "user/orders/<int:order_id>/confirm_delivery/",
        user_confirm_delivery,
        name="user_confirm_delivery",
    ),
